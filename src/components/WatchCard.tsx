...
const WatchCard: React.FC<WatchCardProps> = ({ watch }) => {
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden">
      ...
      <div className="p-4">
        <h2 className="text-lg font-semibold mb-2">{watch.name}</h2>
        <p className="text-gray-600 mb-4">{watch.price.toLocaleString('fr-FR', { style: 'currency', currency: 'EUR' })}</p>
        <button className="bg-blue-600 text-white px-4 py-2 rounded-md flex items-center justify-center w-full hover:bg-blue-700 transition-colors">
